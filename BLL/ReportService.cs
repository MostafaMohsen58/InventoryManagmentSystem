...
public class ReportService
{
    ...
    //public string GenerateHtmlReport(int saleid)
    //{
    //    string filePath = Path.Combine(Directory.GetParent(AppDomain.CurrentDomain.BaseDirectory).Parent.Parent.Parent.FullName, "receipt.html");
    ...
    //    if (sale == null)
    //    {
    //        return null; // Indicate no sales data
    //    }
    ...
    //    string tempFilePath = Path.Combine(Path.GetTempPath(), "receipt.html");
    //    File.WriteAllText(tempFilePath, finalHtml);
